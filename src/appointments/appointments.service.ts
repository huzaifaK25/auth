...
export class AppointmentsService {
    ...
    async createAppointment(doctor_id: number, patient_id: number, dto: CreateApointmentDto) {
        try {
    ...
    async getAppointmentsByDoctor(id: number) {
        try {
            ...
            if (appts) return {profile: user, message: `Here are all your appointments`, appts}
